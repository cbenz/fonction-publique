# -*- coding: utf-8 -*-
"""
Created on Wed May 03 18:29:45 2017
...
import pandas as pd
import numpy as np
from clean_data_initialisation import merge_careers_w_grille, clean_careers_t_t_1, get_cas_uniques, clean_data_carriere_initial
from imputation_indicatrice_de_changement_de_grade_retrospective import impute_indicatrice_chgmt_grade, map_cas_uniques_to_data, get_indiv_who_change_grade_or_not_at_t
    ...
    for annee in annees:
        ...
        data_a_utiliser_pour_annee_precedente = get_indiv_who_change_grade_or_not_at_t(
            data_annee_et_annee_bef_avec_grades_predits,
                False,
                annee)
        print "Il y a {} agents qui ne changent peut-être pas ou certainement pas de grade en {}".format(
        ...
        data_a_storer = get_indiv_who_change_grade_or_not_at_t(
               ...
               True,
               annee)
        print "Il y a {} agents qui changent peut-être ou certainement de grade en {}".format(len(data_a_storer), annee)
