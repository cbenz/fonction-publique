...
def get_cas_uniques(data_t_t_1):
...
def merge_cas_uniques_w_grades_2005_2006():
    cas_uniques_w_indicatrice_chgmt_grade = []
    for grade in ['TTH1', 'TTH2', 'TTH3', 'TTH4']:
        cas_uniques_w_indicatrice_chgmt_grade.append(
            get_indicatrice_de_changement_de_grade_pour_cas_uniques_de_2006(cas_uniques, grade)
            )
...
def map_cas_uniques_de_2005_2006_to_data(data_2005_2006):
    cas_uniques_w_grade = merge_cas_uniques_w_grades_2005_2006()
...
data_2005_2006 = clean_carriere_t_t_1(data_non_chgmt_2006, data_carrieres_1995_2015, 2005)
cas_uniques = get_cas_uniques(data_2005_2006)x = get_grilles_en_effet_en_2005('TTH1')
cas_uniques_2005_2006_w_grade = get_indicatrice_de_changement_de_grade_pour_cas_uniques_de_2006(
    cas_uniques, 'TTH1')
cas_uniques_with_indic = merge_cas_uniques_w_grades_2005_2006()
data_with_indic_chgmt_2005_2006 = map_cas_uniques_de_2005_2006_to_data(data_2005_2006)
