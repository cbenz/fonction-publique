...
#def impute_counterfactual_echelon(data_long, grilles):
#    data_non_censored = data.query(
#        '(right_censored == False) & (annee == last_y_observed_in_grade)'
#        ).copy()
#    dict_c_cir_to_cneg = {
#        "TTH1":793,
#        "TTH2":794,
...
#        "TTH4":796,
#        }
#    data_non_censored['grade'] = data_non_censored['c_cir_2011'].map(dict_c_cir_to_cneg)
#    data_non_censored = data_non_censored[['ident', 'date_effet_grille', 'grade', 'echelon']].rename(
#        columns = {'date_effet_grille':'period'}
#        )
#    grilles = clean_grille(grilles, True, table_corresp_grade_corps)
#    data_merged = data_non_censored.merge(grilles, on = ['c_cir', 'annee_effet'])[[
#        'ident', 'date_effet_grille', 'code_grade', 'echelon'
#        ]].rename(columns = {'date_effet_grille':'period'})


#data_quarterly_long.to_csv(os.path.join(
#    output_directory_path,
#    "clean_data_finalisation",
