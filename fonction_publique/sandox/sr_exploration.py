...
# Loading file 
hdf5_file_path = ('/Users/simonrabate/Desktop/data/CNRACL/clean/debug/1970_1979.hdf5')
...
tmp.groupby(['generation', 'trimestre']).count()
...
duree_carriere_by_grade.max_mois.sort_values()