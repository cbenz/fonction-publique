...
\input{Tables/AT_data_count1.tex}
\bottomrule
\end{tabular}
\end{table}
...
\midrule
Filtre F1 &&&&&& \\ \midrule
\input{Tables/AT_data_quality2_1.tex} 
\midrule
Filtre F2 &&&&&& \\ \midrule
\input{Tables/AT_data_quality2_2.tex}   
\midrule
Filtre F3 &&&&&& \\ \midrule
\input{Tables/AT_data_quality2_3.tex}   
\bottomrule
\end{tabular}
\begin{minipage}{12cm}
\footnotesize
...
\toprule
 ...
 & 793 & 794 & 795 & 796 \\ 
  \hline
\input{Tables/AT_transition_entry.tex}  
   \hline
\bottomrule
\end{tabular}
\begin{minipage}{12cm}
...
\toprule
 ...
 & 793 & 794 & 795 & 796 \\ 
  \hline
\input{Tables/AT_transition_exit.tex}  
   \hline
\bottomrule
\end{tabular}
\begin{minipage}{12cm}
...
\begin{tabular}{lcc}
\toprule
\input{Tables/AA_sample_selection.tex}
\bottomrule
\end{tabular}
\end{table}
...
\toprule
 ...
 \midrule
 & Nb obs & \% ech init  & Nb obs & \% ech init & Nb obs & \% ech init & Nb obs & \% ech init  \\
\input{Tables/AA_data_count1.tex}
\bottomrule
\end{tabular}
\end{table}
...
\toprule
 ...
 & 791 & 792 & 14 & 162 \\ 
  \hline
\input{Tables/AA_transition_entry.tex}  
   \hline
\bottomrule
\end{tabular}
\end{table}
...
\toprule
 ...
 & 791 & 792 & 14 & 162 \\ 
  \hline
\input{Tables/AA_transition_exit.tex}  
   \hline
\bottomrule
\end{tabular}
\end{table}
...
\begin{tabular}{lcc}
\toprule
\input{Tables/AS_sample_selection.tex}
\bottomrule
\end{tabular}
\end{table}
...
\toprule
 ...
 \midrule
 & Nb obs & \% ech init  & Nb obs & \% ech init & Nb obs & \% ech init & Nb obs & \% ech init  \\
\input{Tables/AS_data_count1.tex}
\bottomrule
\end{tabular}
\end{table}
...
\toprule
 ...
 & 839 & 840 & 841  & 773 \\ 
  \hline
\input{Tables/AS_transition_entry.tex}  
   \hline
\bottomrule
\end{tabular}
\end{table}
...
\toprule
 ...
 & 839 & 840 & 841  & 773 \\ 
  \hline
\input{Tables/AS_transition_exit.tex}  
   \hline
\bottomrule
\end{tabular}
\end{table}
