            ...
            if c_cir_now == 'TTH1':
                ...
                if len(grille_c_cir_now_lower) == 0:
                    ...
                    cas_uniques_with_indic_chgmt_grade.append(format_output(
                        ...
                        change_grade_before = True,
                        annee = annee,
                        echelon = None, #grille_c_cir_now_lower['echelon'].values.astype(int)[0],
                        min_mois = None, #grille_c_cir_now_lower['min_mois'].values.astype(int)[0],
                        max_mois = None, #grille_c_cir_now_lower['max_mois'].values.astype(int)[0],
                        date_effet_grille = None, #grille_c_cir_now_lower['date_effet_grille'].values[0],
                        corps = None #grille_c_cir_now_lower['corps_NETNEH'].values.astype(str)[0],
                        ))
