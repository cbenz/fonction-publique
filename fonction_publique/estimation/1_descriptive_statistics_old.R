...
datasets = load_and_clean(data_path, "clean_data_finalisation/data_ATT_2002_2015_with_filter_on_etat_at_exit_and_change_to_filter_on_etat_grade_corrected.csv")
data_max = datasets[[1]]
data_min = datasets[[2]]
...
plot_hazards = function(hazard, colors, type, title)
{
  ...
  plot(years,rep(NA,length(years)),ylim=limits, ylab="Hazard rate",xlab="Anne")
  title(title)
...
barplot(prop_entry[2,],ylab="Proportion d'entre",xlab="Anne", col = "darkcyan", names.arg = time, main = "TTH1")
barplot(prop_entry[3,],ylab="Proportion d'entre",xlab="Anne", col = "darkcyan", names.arg = time, main = "TTH2")
barplot(prop_entry[4,],ylab="Proportion d'entre",xlab="Anne", col = "darkcyan", names.arg = time, main = "TTH3")
barplot(prop_entry[5,],ylab="Proportion d'entre",xlab="Anne", col = "darkcyan", names.arg = time, main = "TTH4")
dev.off()
